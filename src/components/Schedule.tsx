  ...
  return (
    <section id="schedule" className="py-24 px-6 bg-haldi relative">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Special Event: 24th Satyanarayan Puja */}
        {specialScheduleEvents.map((event, idx) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-gradient-to-r from-[#2B1B15] via-[#381F15] to-[#24150F] text-haldi p-8 md:p-10 rounded-3xl shadow-2xl border-2 border-sona/50 relative overflow-hidden group"
          >
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
              ...
              <div className="flex flex-col sm:flex-row md:flex-col gap-3 shrink-0 w-full md:w-auto">
                <div className="flex items-center gap-2.5 bg-black/40 px-5 py-2.5 rounded-xl border border-sona/30 text-sm font-semibold text-sona">
                  <Calendar size={17} className="text-kesari shrink-0" />
                  <span>{event.date} ({event.day})</span>
                </div>

                <div className="flex items-center gap-2.5 bg-black/40 px-5 py-2.5 rounded-xl border border-sona/30 text-sm font-semibold text-yellow-200">
