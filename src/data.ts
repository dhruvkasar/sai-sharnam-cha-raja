...
export const competitions: CompetitionItem[] = [
  ...
  },
  {
    ...
    time: "सायंकाळी ६:०० ते १०:०० मध्ये",
    title: "लकी ड्रॉ",
    englishTitle: "Lucky Draw",
    audience: "केवळ वर्गणीदार सभासद (फ्लॅट्स)",
    desc: "सोसायटीतील सर्व वर्गणीदार सभासदांसाठी महालकी ड्रॉ आणि आकर्षक बक्षिसे.",
    note: "टीप: लकी ड्रॉमध्ये केवळ वर्गणीदार सभासदांचाच (फ्लॅट्स) समावेश केला जाईल.",
    categoryBadge: "विशेष ड्रॉ"
  },
  {
    id: 15,
    day: 8,
